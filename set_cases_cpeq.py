...
sample = sample_gen.main(SIZE, col_names, SAMPLE_NAME, sobol=False)
...
for i in range(len(sample)):
    ...
    output = (FOLDER+'/cluster'+name_length_cluster.format(cluster_n)+'/'+NAME_STDRD+'_{}.epJSON'.format(case))
    df = df.append(pd.DataFrame([sample_line+['cluster'+name_length_cluster.format(cluster_n),NAME_STDRD+'_{}.epJSON'.format(case)]],columns=col_names+['folder','file']))
    # print(output)
    whole_gen.main(
    ...
    for i in range(6):
        ...
        output = (FOLDER+'/cluster'+name_length_cluster.format(cluster_n)+'/'+NAME_STDRD_2+'_noeq_10'+'_{}_'.format(case)+str(i)+'.epJSON')
        df = df.append(pd.DataFrame([sample_line+['cluster'+name_length_cluster.format(cluster_n),NAME_STDRD_2+'_noeq_10'+'_{}_'.format(case)+str(i)+'.epJSON'.format(case)]],columns=col_names+['folder','file']))
        ...
        output = (FOLDER+'/cluster'+name_length_cluster.format(cluster_n)+'/'+NAME_STDRD_2+'_cpeq_10'+'_{}_'.format(case)+str(i)+'.epJSON')
        df = df.append(pd.DataFrame([sample_line+['cluster'+name_length_cluster.format(cluster_n),NAME_STDRD_2+'_cpeq_10'+'_{}_'.format(case)+str(i)+'.epJSON'.format(case)]],columns=col_names+['folder','file']))
        singlezone_diss.main(
            zone_area = model_values['area'], 
            zone_ratio = model_values['ratio'],
            zone_height = model_values['zone_height'],
...
df = other_crack_fac.main(df, pattern='_10_')
