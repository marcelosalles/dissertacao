...
\begin{document}
	...
	Dentre os objetivos específicos deste trabalho, destacam-se:
		...
		\begin{itemize}
			...
			\item desenvolver um modelo de simulação termoenergética, capaz de representar as relações com o edifício com apenas uma zona térmica. % MELHORAR!!!
		\end{itemize}
	...
	\chapter{Metodologia}
		...
		\begin{itemize}
			\item orientação solar;
			\item número de pavimentos;
			\item forma dos pavimentos e das salas;
			\item áreas dos pavimentos e das salas de escritório;
			\item razão entre as dimensões dos pavimentos e das salas de escritório;
