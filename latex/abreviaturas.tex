...
\newacronym{cp}{Cp}{coeficientes de pressão do vento}
\newacronym{cpeq}{Cp$_{eq}$}{coeficiente de pressão equivalente}
\newacronym{cd}{Cd}{coeficiente de descarga}
...
\newglossaryentry{cq}{	% how the symbol will be called in the text \gls{x}
type=symbols,		% set the glossary entry type as "symbol"
name={\ensuremath{C_q}},	
