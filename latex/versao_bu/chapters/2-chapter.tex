...
\begin{quadro}[htb]
	...
	\end{tabular}
	\fonte{\citeonline{NBR14724:2011}.}
\end{quadro}
...
De acordo com \citeonline{ibge1993}, tabela é uma forma não discursiva de apresentar informações em que os números representam a informação central. Ver \autoref{tab:Tab_1}.
