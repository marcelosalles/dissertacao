...
\addbibresource{library.bib} % Seus arquivos de referências
...
\centro{Campus Universitário Trindade}
\preambulo
{%
...
\input{abreviaturas} % para atualizar a lista, usar o comando "makeglossaries dissertacao" no terminal
% compila a lista de abreviaturas e siglas e a lista de símbolos
\makenoidxglossaries 
