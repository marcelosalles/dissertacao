\documentclass[brazil,hardcopy,openany,a4paper]{_ufscthesis}
...
\orientador[Universidade Federal de Santa Catarina]{Prof. Roberto Lamberts, PhD.}
\coordenador[Universidade Federal de Santa Catariana]{Prof. Glicério Trichês, Dr.}
\orientadornabanca{sim} % Se faz parte da banca definir como sim
\coorientadornabanca{nao} % Se faz parte da banca definir como sim
\bancaMembroA{Prof. Ricardo Rütter, PhD.\\Universidade Federal de Santa Catarina}  %Nome do presidente da banca
\bancaMembroB{Prof. Saulo Guths, Dr.\\Universidade Federal de Santa Catarina}   % Nome do membro da Banca
\bancaMembroC{Profa. Denise Helena Silva Duarte, Dra.\\Universidade de São Paulo} % Nome do membro da Banca
