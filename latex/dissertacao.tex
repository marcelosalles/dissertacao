...
\textabstract {
	...
	A solution to mitigate energy use for air cooling is the use of natural ventilation (NV).
	...
	The aim of this study is to develop a neural network surrogate model to estimate thermal comfort in naturally ventilated office buildings.
