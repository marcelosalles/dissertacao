...
\citeauthoronline{Melo2016} \cite{Melo2016} desenvolveram um modelo de \acrfull{ann} para estimar graus hora de resfriamento e cargas térmicas de aquecimento e resfriamento em edificações residenciais.
...
\begin{figure}[H]
	...
	\includegraphics[width=.5\linewidth]{img/cpeq_pareto.png}
	\label{fig:pareto}
	%			\begin{flushleft}
	%				Fonte: o autor.
	%			\end{flushleft}
...
A partir das 100.000 simulações geradas para o treinamento da rede neural artificial (\acrshort{ann}), obteve-se resultados de EHF variando entre 0,00 e 1,00.
