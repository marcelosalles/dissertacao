...
def main(zone_area=10, zone_ratio=1.5, zone_height=3, absorptance=.5, 
    ...
    for i in range(n_zones):
        ...
        # Top Condition
        if i >= (n_zones - zones_x_floor):  # roof:  # 
            ceiling_bound = {
